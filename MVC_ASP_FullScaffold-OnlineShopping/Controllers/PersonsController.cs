...
namespace MVC_ASP_FullScaffold_OnlineShopping.Controllers
{
    public class PersonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,NationalCode,FirstName,Surname,Country,DateofBirth,ContactEmail,MobileNumber,Username,Password,Address")] Person person)
        {
